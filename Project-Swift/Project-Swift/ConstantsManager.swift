...
class ConstantsManager{
    ...
    public static let PLISTKEY_PUSH_NOTIFICATION_TOKEN:String = "firebase_token"
    ...
    public static let SERVICE_REGISTER_TOKEN:String = "https://agile-harbor-96428.herokuapp.com/api/v1/users"
