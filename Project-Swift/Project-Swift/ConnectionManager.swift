...
class ConnectionManager
{
    ...
    //MARK: - • PUBLIC METHODS
    func registerTokenWithParameters(params:Dictionary<String, Any>, handler:@escaping (_ response:Dictionary<String, Any>?, _ statusCode:Int, _ error:NSError?) -> ()){
        
        //Headers
        let header: HTTPHeaders = self.createDefaultHeader()
        
        //Request
        Alamofire.request(App.Constants.SERVICE_REGISTER_TOKEN,
